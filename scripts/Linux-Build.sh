...
g++ ../../googletest/src/gtest_main.cc  ../../googletest/samples/sample9.cc ../../googletest/samples/sample9_unittest.cc -o output2 -lpthread -lgtest
g++ ../../googletest/samples/sample10.cc ../../googletest/samples/sample9_unittest.cc -o output3 -lpthread -lgtest